        ...
        <section id="hero" className="container padding-global">
            <div className="hero-content">
                ...
                <div className="hero-text">
                    <p>Formé par OpenClassrooms, je dispose d'une expérience de deux ans en agence en tant qu'Intégrateur Web. Collaborons ensemble pour réaliser le <strong>site ou application Web de vos rêves à votre image</strong> !</p>
                </div>
